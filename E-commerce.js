// Console Application - Food Store App
...
while (makingChoice === true) {
  ...
  choice = prompt(
    " Choose from the following options:\n A. View Cart 🛒\n B. Add a product to Cart 🛒\n C. Remove a product from cart 🛒\n D. Increment Quantity of Product in Cart 🛒\n E. Decrement Quantity of Product in Cart 🛒\n F. Checkout 💳 \n Q. Exit Application \n\n"
  );
  ...
  if (choice === "a") {
    ...
    let productId = prompt(
      "What is the id of the product you want to remove from cart? "
    );
    console.log(">>>>>>>>>>");
    console.log("");
    console.log("");
    ...
    console.log(">>>>>>>>>>");
    let productId = prompt(
      "What is the id of the product you want to increment in your cart? >>> "
    );
    console.log(">>>>>>>>>>");
    console.log("");
    console.log("");
    ...
    try {
      ...
      console.log("Item successfully incremented");
    } catch (error) {
      console.log(error.message);
    }
  } else if (choice === "e") {
    ...
    console.log(">>>>>>>>>>");
    let productId = prompt(
      "What is the id of the product you want to decrement its quantity inside cart? >>>  "
    );
    console.log(">>>>>>>>>>");
    console.log("");
    console.log("");
    ...
    try {
      ...
      console.log("Item successfully decremented");
    } catch (error) {
      console.log(error.message);
    }
  } else if (choice === "f") {
